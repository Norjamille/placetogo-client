    ...
    <nav class="flex items-center justify-between" aria-label="Global">
        <div class="flex lg:flex-1">
            <a href="#" class="-m-1.5 p-1.5">
                ...
                <svg id="logo-82" width="40" height="28" viewBox="0 0 40 28" fill="none"
        ...
        <div class="hidden lg:flex lg:gap-x-12">
            <a v-for="(nav, index) in navs" :key="index" :href="nav.path"
                class="text-sm font-semibold leading-6 text-gray-800 hover:scale-105 transform duration-150 ease-in-out">
                {{ nav.name }}
            </a>
        </div>
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
            <a href="#" class="text-sm font-semibold leading-6 text-indigo-600">Log in <span
